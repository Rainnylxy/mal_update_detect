...
try:
    from ..analysis import joern as joern_helper
    from ..analysis import graph_utils as graph_helper
    from ..analysis.treesitter import closest_block_line, extract_import_lines
except ImportError:
    from src.analysis import joern as joern_helper
    from src.analysis import graph_utils as graph_helper
    from src.analysis.treesitter import closest_block_line, extract_import_lines
